...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("RUC");
    case mBTC: return QString("mRUC");
    case uBTC: return QString::fromUtf8("μRUC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("RUCoins"));
    case mBTC: return QString(QObject::tr("Milli-RUCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-RUCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
